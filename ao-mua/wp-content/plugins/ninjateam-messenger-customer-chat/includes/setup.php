...
if(get_option('njt_customer_chat_app_token')){
	$user_token=get_option('njt_customer_chat_app_token');
	$check=$fb_api->check_token_live($user_token);
}
?>
<?php if(!get_option('njt_customer_chat_enable') || empty(get_option('njt_customer_chat_list_page'))) {?>
			...
			<?php }?>
	<?php }else if(get_option('njt_customer_chat_app_token') && !empty(get_option('njt_customer_chat_list_page')) && get_option('njt_customer_chat_enable')){ ?>
		<?php
