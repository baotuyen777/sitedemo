...
?>
        ...
        <form id="form" method="POST">
			...
			<div class="muahangnhanh-panel-body">
				...
				<label class="muahangnhanh-label" for="addtion"><b>Thông tin thêm</b></label>
				<textarea id="result" style="width:100%; height: 60px;" class="muahangnhanh-box result w50r" name="addtion"><?php echo str_replace('\\','',$item[addtion]) ?></textarea><br />
				<script>
