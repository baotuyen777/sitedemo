<div class="wrap">
        ...
        <p class="title-des">Our messenger plugins to help grow your Facebook Fan Page and boost your sales</p>
        <div class="njt-t-fbmess-row">
            <div class="njt-t-fbmess-col-4">
                <div class="njt-t-fbmess-colinner">
                    <img src="<?php echo NJT_CUSTOMER_CHAT_URL . '/assets/images/more-plugins/bulksender.png'; ?>" alt="Messenger Bulksender" />
            ...
            <div class="njt-t-fbmess-col-4">
                <div class="njt-t-fbmess-colinner">
                    <img src="<?php echo NJT_CUSTOMER_CHAT_URL . '/assets/images/more-plugins/private-reply.png'; ?>" alt="Messenger Auto-Reply" />
                    <div class="njt-t-fb-mess-info">
            ...
            <div class="njt-t-fbmess-col-4">
                <div class="njt-t-fbmess-colinner">
                    <img src="<?php echo NJT_CUSTOMER_CHAT_URL . '/assets/images/more-plugins/ninja-team.png'; ?>" alt="NinjaTeam Plugins" />
                    <div class="njt-t-fb-mess-info">
