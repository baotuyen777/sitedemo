...
<?php
	...
	class muahangnhanh extends WP_List_Table {
        ...
        function prepare_items()
        {
            ...
            $per_page = 20; // how much records will be shown per page
            ...
            $hitems = $this->items = $wpdb->get_results($wpdb->prepare("SELECT * FROM $table_name ORDER BY $orderby $order LIMIT %d OFFSET %d", $per_page, $paged * $per_page), ARRAY_A);
