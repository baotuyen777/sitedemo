...
("17","1","gdd_dashboard_quick_press_last_post_id","649"),
...
("22","1","gdd_user-settings-time","1557453031"),
...
CREATE TABLE `gdd_wc_avatars_cache` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `gdd_wc_comments_subscription` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `gdd_wc_follow_users` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `gdd_wc_users_voted` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
